...
class ManagePrinter2Page extends StatefulWidget {
  const ManagePrinter2Page({super.key});

  @override
  State<ManagePrinter2Page> createState() => _ManagePrinter2PageState();
}

class _ManagePrinter2PageState extends State<ManagePrinter2Page> {
  int selectedIndex = 0;
