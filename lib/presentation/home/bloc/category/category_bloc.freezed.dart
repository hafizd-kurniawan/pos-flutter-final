...
class Success implements CategoryState {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Success&&const DeepCollectionEquality().equals(other._categories, _categories));
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<$Res> implements $CategoryStateCopyWith<$Res> {
...
class Failure implements CategoryState {
...
/// @nodoc
abstract mixin class $FailureCopyWith<$Res> implements $CategoryStateCopyWith<$Res> {
