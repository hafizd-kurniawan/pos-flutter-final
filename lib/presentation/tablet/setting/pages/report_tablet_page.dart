...
import '../../../setting/bloc/product_sales/product_sales_bloc.dart'
    as product_sales;
                      ...
                      builder: (context, state) {
                        switch (state) {
                          ...
                          case product_sales.Loaded(
                            ...
                            dummyProductSalesResponse,
                          ):
                            productSales = dummyProductSalesResponse.data;
                            int totalQty = 0;
                            int totalPrice = 0;
                            for (var element
                                in dummyProductSalesResponse.data) {
                              totalPrice += element.totalPrice.toInt();
                              totalQty +=
                                  element.totalQuantity.toIntegerFromText;
                            }
                            if (dummyProductSalesResponse.data.isEmpty) {
                              return const Center(
            ...
            return Row(
              children: <Widget>[
                ...
                Container(
                  ...
                  alignment: Alignment.centerLeft,
                  child: Center(
                    child: Text(productSales.totalPrice.currencyFormatRp),
                  ),
                ),
              ],
            );
...
class Summary {
  ...
  factory Summary.fromMap(Map<String, dynamic> map) {
    return Summary(
      ...
      totalSoldQuantity:
          map['total_sold_quantity'] is String
