...
import 'package:flutter_pos_responsive_app/presentation/setting/widgets/menu_printer_button.dart';
import 'package:flutter_pos_responsive_app/presentation/setting/widgets/menu_printer_content.dart';
...
import '../../../../data/models/response/print_model.dart';
              ...
              child: Button.filled(
                onPressed: () async {
                  ...
                  if (selectedSize != null && macName.isNotEmpty) {
                    ...
                    AuthLocalDatasource().saveSizeReceipt(
                      selectedSize.toString(),
                    );

                    // Simpan printer ke list lokal
                    final existingPrinters = await AuthLocalDatasource()
                        .getPrinters();
                    ...
                    if (!alreadyExists) {
                      ...
                      await AuthLocalDatasource().savePrinters(
                        existingPrinters,
                      );
                    }
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Text(
                          'Pilih ukuran dan printer terlebih dahulu',
                        ),
                      ),
                    );
                  }
                ...
                ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      subtitle: Text(
                        '${printer.macAddress} • ${printer.paperSize} mm',
                      ),
                      trailing: Row(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          ...
                          Button.outlined(
                            ...
                            onPressed: () async {
                              await AuthLocalDatasource().setDefaultPrinter(
                                printer,
                              );
                          ...
                          IconButton(
                            ...
                            onPressed: () async {
                              final isPrinterDefault =
                                  defaultMac == printer.macAddress;

                              final updated = List<PrinterModel>.from(
                                savedPrinters,
                              )..removeAt(index);
                              ...
                              if (isPrinterDefault) {
                                ...
                                final isConnected = await PrintBluetoothThermal
                                    .connectionStatus;
                                if (isConnected) {
